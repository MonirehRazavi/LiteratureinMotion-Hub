...
# 3. The properties we need to know
...
# 4. Opening the Wikidata Query Service
...
# 5. A first test query (baby steps)
...
Interested to learn more: Check out [Wikidata:SPARQL tutorial](https://www.wikidata.org/wiki/Wikidata:SPARQL_tutorial).
...
## 7. The real query: Translations and Adaptations
...
## 10. Example of what you’ll see

Show your csv file to the classmate siting next to you. 
...
2. Linking **Wikidata** with Other Datasets
...
4. Visualization Tools for **SPARQL** Results
...
4. Victor Hugo (France)

5. Miguel de Cervantes (Spain)

6. Dante Alighieri (Italy)

7. Johann Wolfgang von Goethe (Germany)

8. Franz Kafka (Austria/Czechia)

9. Gabriel García Márquez (Colombia)

10. Mario Vargas Llosa (Peru)

11. Naguib Mahfouz (Egypt)
...
15. Ngũgĩ wa Thiong’o (Kenya)

16. Haruki Murakami (Japan)

17. Khaled Hosseini (Afghanistan/USA)

18. Toni Morrison (USA)

19. Jorge Luis Borges (Argentina)
